...
export declare function wasDaemonAvailable(): boolean;
/**
 ...
 */
export declare function dbWriteViaDaemon(table: 'turns' | 'op_history' | 'compacts', operation: 'insert' | 'insert_or_replace', record: Record<string, unknown>): Promise<boolean>;
/**
