...
export interface SessionContext {
    ...
    /**
     * Per-window correlation handle (Claude Code session id / equivalent for
     * other hookful clients). Sent as `X-Gramatr-Client-Session` so the server's
     * session/context resource handler resolves precisely for THIS window, not
     * via the user-keyed last-write-wins fallback. Introduced v0.20.25 PR #2775.
     */
 ...
 */
export declare function fetchRemoteResource(uri: string, sessionContext?: SessionContext): Promise<unknown>;
