 ...
 */
export declare function writeDaemonToken(token: string): void;
/** Read the shared daemon auth token. Returns null if the file is missing. */
export declare function readDaemonToken(): string | null;
 ...
 */
export declare function terminateOrphanDaemon(): void;
 ...
 */
export declare function writeGramatrBinary(): void;
