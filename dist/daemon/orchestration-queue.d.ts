 ...
 */
import type { OrchestrationRun, OrchestrationTask, OrchestrationApproval, OrchestrationTaskStatus, OrchestrationApprovalStage, OrchestrationApprovalStatus, OrchestrationProjectSummary } from './ipc-protocol.js';
...
export declare function updateRun(id: string, fields: Partial<Pick<OrchestrationRun, 'status' | 'prd_entity_id' | 'prd_content' | 'breakdown_json'>>): OrchestrationRun | null;
