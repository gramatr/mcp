...
export function createRun(params) {
    ...
    INSERT INTO orchestration_runs
      (id, user_id, project_id, goal, status, execution_mode, tags, base_branch, created_at, updated_at)
    VALUES (?, ?, ?, ?, 'prd_writing', ?, ?, ?, ?, ?)
  `).run(id, params.user_id, params.project_id, params.goal, mode, params.tags ?? null, params.base_branch ?? null, ts, ts);
    return getRun(id);
}
