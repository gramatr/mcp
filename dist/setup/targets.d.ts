...
export declare function buildLocalMcpServerEntry(home: string, serverUrl: string, platform?: string): McpCommandServerEntry;
...
export declare function buildGeminiHooksFile(home: string, platform?: string): GeminiHooksFile;
