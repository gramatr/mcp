 ...
 * Generated: 2026-04-29T21:24:50.293Z
 */
...
/** gramatr for Claude — Claude.ai official MCP add-on — Anthropic partner program, sandbox environment */
export const CLAUDE_ADDON_HOOKS = {
    "name": "claude-addon",
    "display_name": "gramatr for Claude",
...
export const CLAUDE_CODE_HOOKS = {
    ...
    "hooks": {
        ...
        "SubagentStart": [
            {
                "hook": "subagent-route",
                "statusMessage": "Routing sub-agent through gramatr intelligence"
            }
        ],
        "TaskCreated": [
            {
        ...
        "InstructionsLoaded": [
            {
                ...
                "statusMessage": "Loading gramatr project context",
                "matcher": "CLAUDE.md"
            }
        ]
    },
    ...
    "settings": {
        "statusLine": {
            "type": "command",
            "command": "npx -y --prefer-offline @gramatr/mcp statusline"
        },
        "attribution": {
        ...
        "SessionStart": [
            {
                ...
                "statusMessage": "Loading grāmatr session context",
                "timeout": 15
            }
        ],
        "UserPromptSubmit": [
            {
                "hook": "user-prompt-submit",
                "statusMessage": "Routing request through grāmatr",
                "timeout": 15
            }
        ],
        "Stop": [
            {
                "hook": "session-end",
                "statusMessage": "Saving grāmatr session state",
                "timeout": 15
            },
            {
                "hook": "stop",
                "statusMessage": "Submitting grāmatr classification feedback",
                "timeout": 10
            }
        ]
    },
        ...
        "SessionStart": [
            {
                ...
                "timeout": 15,
                "description": "Load grāmatr session context and handoff"
            }
        ],
        "BeforeAgent": [
            {
                ...
                "timeout": 15,
                "description": "Route prompt through grāmatr intelligence"
            }
        ],
        "SessionEnd": [
            {
                ...
                "timeout": 15,
                "description": "Persist grāmatr session state and save handoff"
            },
            {
                "hook": "stop",
                "name": "gramatr-session-feedback",
                "timeout": 10,
                "description": "Submit classification feedback to grāmatr"
            }
        ]
    },
    "mcp_server": {
