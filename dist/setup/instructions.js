...
import { CONTRACT_RULES, MEMORY_RULES, REQUIRED_FIELDS, QUALITY_GATE_REQUIREMENT, FEEDBACK_RULES, SUBAGENT_RULES, EFFORT_PHASES, DEGRADED_MODE, PROJECT_UNRESOLVED, PROJECT_NEW, PROJECT_RESUMED, } from './generated/instruction-blocks.js';
...
// As of v0.20.74 the behavioural substrate (Quality Gates, sub-agent
// composition, phase templates, classification summary, project resolution,
// degraded-mode rules) moved out of CLAUDE.md and into the MCP server
// `instructions` field — see contracts/mcp/server-instructions.yaml
// (claude-code variant). Claude Code loads those once at session start.
// The CLAUDE.md fence now carries only the identity pointer + breadcrumb.
