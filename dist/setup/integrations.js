...
const CLAUDE_HOOKS = [
    { event: 'PreToolUse', matcher: 'Agent', mcpHookName: 'agent-gate', hookArgs: ['--claude-code'] },
    { event: 'PreToolUse', matcher: 'Bash', mcpHookName: 'git-gate', hookArgs: ['--claude-code'] },
    ...
    { event: 'PreToolUse', matcher: 'Edit', mcpHookName: 'edit-tracker', hookArgs: ['--claude-code'] },
    { event: 'PreToolUse', matcher: 'Write', mcpHookName: 'input-validator', hookArgs: ['--claude-code'] },
    { event: 'PreToolUse', matcher: 'Write', mcpHookName: 'edit-tracker', hookArgs: ['--claude-code'] },
    ...
    { event: 'PostToolUse', matcher: 'Agent', mcpHookName: 'agent-verify', hookArgs: ['--claude-code'] },
