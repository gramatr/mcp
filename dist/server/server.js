...
export function createServer() {
    const server = new Server({ name: SERVER_NAME, version: SERVER_VERSION }, { capabilities: { tools: {}, prompts: {}, resources: {} } });
...
export async function startServer() {
    ...
    try {
        ...
        process.stderr.write(`[gramatr-mcp] Warning: could not load remote tools (${message}). Starting with empty tool list.\n`);
    }
    // Load remote prompts
    try {
