...
export function isWebTool(name) {
    return name === 'gramatr_local_fetch' || name === 'gramatr_local_search';
}
/**
...
export async function handleWebTool(toolName, args) {
    switch (toolName) {
        case 'gramatr_local_fetch':
            return handleFetch(args);
        case 'gramatr_local_search':
