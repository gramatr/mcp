...
import { buildGeminiExtensionManifest, buildGeminiHooksFile, buildLocalMcpServerEntry, buildOpenCodeMcpServerEntry, getGeminiExtensionDir, getGeminiHooksPath, getGeminiManifestPath, getOpenCodeConfigPath, mergeMcpServerConfig, mergeOpenCodeMcpConfig, } from '../setup/targets.js';
...
export function setupOpenCode(dryRun = false, showPrompts = false) {
    ...
    process.stderr.write('[gramatr] Copy the plugin scaffold from packages/mcp/src/setup/examples/gramatr-opencode-plugin.ts\n');
