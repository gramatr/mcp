...
export declare function setupClaudeCode(dryRun?: boolean, cleanInstall?: boolean, showPrompts?: boolean, showStatusLine?: boolean): void;
/** @deprecated Use setupClaudeCode() — "claude" is a legacy alias */
export declare function setupClaude(dryRun?: boolean, cleanInstall?: boolean, showPrompts?: boolean, showStatusLine?: boolean): void;
