...
type SetupTarget = "all" | "claude-code" | "claude" | "codex" | "opencode" | "claude-desktop" | "chatgpt-desktop" | "gemini" | "cursor" | "windsurf" | "vscode";
export type InstallableTarget = Exclude<SetupTarget, "all">;
export declare const AUTO_TARGET_ORDER: InstallableTarget[];
export declare function setupClaudeCode(dryRun?: boolean, cleanInstall?: boolean, showPrompts?: boolean, showStatusLine?: boolean, remoteUrl?: string): void;
/** @deprecated Use setupClaudeCode() — "claude" is a legacy alias */
export declare function setupClaude(dryRun?: boolean, cleanInstall?: boolean, showPrompts?: boolean, showStatusLine?: boolean, remoteUrl?: string): void;
