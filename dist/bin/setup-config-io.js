...
export function getGramatrPluginDir() {
    const gramatrDir = getGramatrDirFromEnv() || join(HOME, '.gramatr');
    return join(gramatrDir, 'plugins', 'gramatr');
}
export function writeMarketplaceManifest(gramatrDir) {
    ...
    const manifest = {
        name: 'gramatr',
        description: 'gramatr — Real-Time Intelligent Context Engineering. Intelligence hooks, memory, and routing for AI clients.',
