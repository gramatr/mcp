...
import { CLAUDE_BLOCK_END, CLAUDE_BLOCK_START, CLAUDE_CODE_GUIDANCE, CODEX_BLOCK_END, CODEX_BLOCK_START, CODEX_GUIDANCE, } from '../setup/instructions.js';
...
function upsertManagedBlock(existing, content, startMarker, endMarker) {
 ...
 */
function setupMcpTarget(targetName, configPath, dryRun) {
