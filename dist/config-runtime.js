...
/**
 * Turn threshold for auto-compact. Priority:
 *   1. ~/.gramatr/settings.json auto_compact.every_turns
 *   2. GRAMATR_COMPACT_TURNS env var
 *   3. Default: 15
 */
export function getCompactTurnThresholdFromEnv() {
    try {
        ...
        const v = cfg?.auto_compact?.every_turns;
