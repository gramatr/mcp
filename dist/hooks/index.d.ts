 ...
 * in Phase 2.
 */
export type HookRunner = (args: string[]) => Promise<number>;
...
export { runInstructionsLoadedHook } from './instructions-loaded.js';
...
export { runSubagentRouteHook } from './subagent-route.js';
export { runTaskQualityGateHook } from './task-quality-gate.js';
export { runToolTrackerHook } from './tool-tracker.js';
export { runRatingCaptureHook } from './rating-capture.js';
export { runCompactHook } from './compact.js';
export { runUserPromptSubmitHook } from './user-prompt-submit.js';
export { HOOK_MANIFEST, HOOK_NAMES, type HookName } from './manifest.js';
