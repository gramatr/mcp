    ...
    try {
        ...
        const injectionText = [
            ...
            ...(approvedTools.length > 0 ? [
                ...
                `gramatr_orchestrate({action:"request_tools"}) before proceeding.`,
            ...
            `Call gramatr_route_request with your task description.`,
            ...
            ...(task.task_branch ? [
                ...
                `Call gramatr_orchestration_dispatch({`,
                `  action: 'complete',`,
                `  task_id: '${task.id}',`,
