...
export function getSharedStateDir() {
    return join(getGramatrDirFromEnv() || join(getHomeDir(), '.gramatr'), '.state');
}
export function getCurrentProjectContextPath() {
    return join(getSharedStateDir(), 'current-project-context.json');
}
export function getLastSessionCommitsPath() {
    return join(getSharedStateDir(), 'last-session-commits.txt');
}
export function getSessionHistoryLogPath() {
    return join(getSharedStateDir(), 'session-history.log');
}
...
export function writeCurrentProjectContextFile(payload) {
    ...
    const contextFile = getCurrentProjectContextPath();
