...
import { VERSION_FETCH_TIMEOUT_MS, VERSION_CACHE_TTL_MS } from '../generated/hook-timeouts.js';
...
export function formatUpgradeNotification(installed, latest) {
    ...
    return [
        ...
        '    2. Run: npx @gramatr/mcp@latest install claude-code',
 ...
 *
 * Spawns `npx @gramatr/mcp@{version} install claude-code --yes` as a
