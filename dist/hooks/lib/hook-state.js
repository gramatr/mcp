...
let _db = null;
/**
 * Pass-through for better-sqlite3 named parameter binding.
 * better-sqlite3 does NOT require the @ prefix in the object key —
 * it matches { session_id: val } to @session_id in the SQL automatically.
 * (bun:sqlite required the prefix; better-sqlite3 does not.)
 */
function p(obj) {
    return obj;
}
