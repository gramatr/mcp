...
import { type CompactRecord } from './hook-state.js';
...
export declare function normalizeSessionStartResponse(response: SessionStartResponse | null | undefined): {
    ...
    user: NonNullable<SessionStartResponse['user']> | null;
    clientIdentity: NonNullable<SessionStartResponse['client_identity']> | null;
};
