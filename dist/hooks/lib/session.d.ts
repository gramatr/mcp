...
export declare function getSharedStateDir(): string;
export declare function getCurrentProjectContextPath(): string;
export declare function getLastSessionCommitsPath(): string;
export declare function getSessionHistoryLogPath(): string;
