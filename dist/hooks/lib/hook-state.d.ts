...
export declare function appendOpHistory(op: OpRecord): Promise<void>;
...
export declare function saveCompact(record: CompactRecord): Promise<void>;
/** Return the most recent compact for a project, or null if none. */
export declare function getLatestCompactForProject(projectId: string): CompactRecord | null;
 ...
 */
export declare function getLatestPacketForSession(sessionId: string): PacketRecord | null;
/** Returns age in ms of the most recent packet for a session, or undefined if none exists. */
export declare function getLatestPacketAgeMs(sessionId: string, nowMs?: number): number | undefined;
