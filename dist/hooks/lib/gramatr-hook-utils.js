...
import { readFileSync, writeFileSync, renameSync, mkdirSync, existsSync, appendFileSync, chmodSync } from 'fs';
 ...
 *   2. ~/.gramatr/settings.json → auth.user_id — canonical location written by login v2
 *   3. ~/.gramatr.json — legacy location, backward compat for existing installs
