 ...
 * gramatr_route_request classification exists in local SQLite state (same
...
const DENY_REASON = 'Sub-agent launch blocked: no fresh gramatr_route_request classification found. ' +
    'Call gramatr_route_request with the sub-task prompt first, then pass the ' +
    'Quality Gate scaffold from enrichment.data.reasoning.isc_scaffold as the ' +
    "sub-agent's acceptance criteria, and orchestration.agents.composed as the " +
...
const ALLOW_REMINDER = '[gramatr] Sub-agent routing allowed. Remember to pass the Quality Gate scaffold ' +
    ...
    'criteria and orchestration.agents.composed as its system prompt.\n';
