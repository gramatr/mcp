 ...
 * `enrichment.data.reasoning.quality_gate_criteria` to the sub-agent.
 *
...
const DENY_REASON = 'Sub-agent launch blocked: no fresh route_request classification found. ' +
    ...
    'Quality Gate scaffold from enrichment.data.reasoning.quality_gate_criteria as the ' +
...
const ALLOW_REMINDER = '[gramatr] Sub-agent routing allowed. Remember to pass the Quality Gate scaffold ' +
    "from enrichment.data.reasoning.quality_gate_criteria as the sub-agent's acceptance " +
