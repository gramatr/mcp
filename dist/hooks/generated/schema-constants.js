...
// ── Audit ──
export const AUDIT_EVENT_TYPES = ["auth", "entity_crud", "search", "admin", "api_key", "config", "oauth", "export", "tier_floor_breach"];
...
export const DOMAIN_SUB_CREATIVES = ["_unclassified_pending_curation"];
export const DOMAIN_SUB_HEALTHS = ["_unclassified_pending_curation"];
export const DOMAIN_SUB_LEARNINGS = ["_unclassified_pending_curation"];
export const DOMAIN_SUB_RELATIONSHIPS = ["_unclassified_pending_curation"];
export const DOMAIN_SUB_CIVICS = ["_unclassified_pending_curation"];
export const DOMAIN_SUB_LEISURES = ["_unclassified_pending_curation"];
export const DOMAIN_SUB_SCIENCES = ["_unclassified_pending_curation"];
export const DOMAIN_SUB_SPIRITUALITIES = ["_unclassified_pending_curation"];
export const EFFORT_LIGHTS = ["instant", "fast"];
...
export const BERT_HEAD_MEMORY_SCOPE_LABELS = ["session", "project", "user", "team"];
// ── Routing & operational ──
...
// ── Quality Gate (#2233) ──
export const QG_CLAIM_TYPES = ["criterion", "anti_criterion"];
export const QG_CRITERION_STATUSES = ["pending", "pass", "fail"];
