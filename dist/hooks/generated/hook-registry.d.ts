/**
 * Generated: 2026-05-12T19:23:04.500Z
...
export type HookName = 'agent-gate' | 'agent-verify' | 'edit-tracker' | 'git-gate' | 'input-validator' | 'instructions-loaded' | 'session-end' | 'session-start' | 'stop' | 'subagent-route' | 'task-quality-gate' | 'tool-tracker' | 'user-prompt-submit';
