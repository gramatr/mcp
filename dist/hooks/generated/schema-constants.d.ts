 ...
 * Generated: 2026-05-10T15:04:02.789Z
 */
...
export declare const AUDIT_EVENT_TYPES: readonly ["auth", "entity_crud", "search", "admin", "api_key", "config", "oauth", "export", "tier_floor_breach"];
...
export declare const INTENT_ACTION_WRITES: readonly ["create", "modify", "delete", "execute"];
export declare const DOMAIN_SUB_TECHNICALS: readonly ["code", "devops", "backend", "frontend", "security", "data-engineering", "ml", "design"];
export declare const DOMAIN_SUB_BUSINESSES: readonly ["strategy", "product", "finance", "marketing", "operations", "legal", "people"];
export declare const DOMAIN_SUB_PERSONALS: readonly ["personal", "learning", "writing", "research"];
export declare const DOMAIN_SUB_CREATIVES: readonly ["_unclassified_pending_curation"];
export declare const DOMAIN_SUB_HEALTHS: readonly ["_unclassified_pending_curation"];
export declare const DOMAIN_SUB_LEARNINGS: readonly ["_unclassified_pending_curation"];
export declare const DOMAIN_SUB_RELATIONSHIPS: readonly ["_unclassified_pending_curation"];
export declare const DOMAIN_SUB_CIVICS: readonly ["_unclassified_pending_curation"];
export declare const DOMAIN_SUB_LEISURES: readonly ["_unclassified_pending_curation"];
export declare const DOMAIN_SUB_SCIENCES: readonly ["_unclassified_pending_curation"];
export declare const DOMAIN_SUB_SPIRITUALITIES: readonly ["_unclassified_pending_curation"];
export declare const EFFORT_LIGHTS: readonly ["instant", "fast"];
...
export declare const BERT_HEAD_MEMORY_SCOPE_LABELS: readonly ["session", "project", "user", "team"];
...
export declare const QG_CLAIM_TYPES: readonly ["criterion", "anti_criterion"];
export declare const QG_CRITERION_STATUSES: readonly ["pending", "pass", "fail"];
