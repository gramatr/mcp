...
const HOOK_ROUTE_TIMEOUT_CAP_MS = 9000;
const HOOK_PACKET2_TIMEOUT_CAP_MS = 2500;
const HOOK_PACKET2_WAIT_CAP_MS = 4000;
...
export async function runUserPromptSubmitHook(_args = []) {
    ...
    try {
        ...
        const packet2Required = Boolean(manifest?.packet_2_status === 'required'
