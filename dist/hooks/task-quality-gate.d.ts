 ...
 */
import { type TierFloor } from './generated/effort-phases.js';
type TierFloorMode = 'off' | 'warn' | 'enforce';
...
interface QGFloorBreach {
    breach_type: 'qg_criteria' | 'qg_anti_criteria';
    expected: number;
    actual: number;
}
export declare function checkQGFloorsForTaskInput(toolInput: Record<string, unknown> | undefined): {
    mode: TierFloorMode;
    floor: TierFloor | null;
    breaches: QGFloorBreach[];
    effortLevel: string;
};
